...
const REQUIRED = [
    ...
    "repaglinide_binary",
    "nateglinide_binary",
    "chlorpropamide_binary",
    "glimepiride_binary",
    "acetohexamide_binary",
    "glipizide_binary",
    "glyburide_binary",
    "tolbutamide_binary",
    "pioglitazone_binary",
    "rosiglitazone_binary",
    "acarbose_binary",
    "miglitol_binary",
    "troglitazone_binary",
    "tolazamide_binary",
...
export default function PredictPage() {
    ...
    useEffect(() => {
        cacheSet("predict:form", form, 24 * 60 * 60 * 1000);
    }, [form]);
    ...
    const checkHealth = async () => {
        try {
            ...
            setHealth({
                status: "unreachable",
                model_loaded: false,
                message: String(e?.message || "API unreachable"),
            });
        }
    };
    ...
    const submit = async () => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                try {
                    const err = JSON.parse(detailText);
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="text-sm opacity-75">
                Enter values for required features and submit to the FastAPI
                model.
            </div>
            <div className="card">
                <div className="flex items-center justify-between">
                    <div className="text-sm">
                        API: <span className="font-mono opacity-80">{API}</span>{" "}
                        • Status:{" "}
