        ...
        script.innerHTML = `(${function () {
            (function () {
                ...
                const patients: Patient[] = [
                    {
                        ...
                        drivers: [
                            {
                                factor: "High Blast Percentage (25%)",
                                influence: "high",
                            },
                            { factor: "NPM1 Mutation", influence: "high" },
                            {
                                factor: "Low Platelet Count",
                                influence: "medium",
                            },
                        ],
                        actions: [
                    ...
                    },
                    {
                        ...
                        drivers: [
                            {
                                factor: "High M-protein (SPEP)",
                                influence: "high",
                            },
                            {
                                factor: "Bone lesions on CT scan",
                                influence: "high",
                            },
                            {
                                factor: "Elevated B2M levels",
                                influence: "medium",
                            },
                        ],
                        actions: [
                    ...
                    },
                    {
                        ...
                        drivers: [
                            {
                                factor: "Enlarged lymph nodes (PET scan)",
                                influence: "high",
                            },
                            {
                                factor: "Elevated LDH levels",
                                influence: "medium",
                            },
                            {
                                factor: "Reported night sweats",
                                influence: "low",
                            },
                        ],
                        actions: [
                    ...
                    },
                    {
                        ...
                        drivers: [
                            {
                                factor: "High Lymphocyte Count",
                                influence: "medium",
                            },
                            {
                                factor: "Enlarged Spleen (physical exam)",
                                influence: "low",
                            },
                        ],
                        actions: [
                    ...
                    },
                    {
                        ...
                        drivers: [
                            {
                                factor: "Normal CBC values",
                                influence: "high-negative",
                            },
                            {
                                factor: "No concerning symptoms",
                                influence: "high-negative",
                            },
                        ],
                        actions: [
                    ...
                    },
                    {
                        ...
                        drivers: [
                            {
                                factor: "Philadelphia chromosome positive",
                                influence: "high",
                            },
                            {
                                factor: "Elevated WBC and Platelet counts",
                                influence: "medium",
                            },
                        ],
                        actions: [
                            "Start Tyrosine Kinase Inhibitor (TKI) therapy",
                            "Monitor molecular response with PCR",
                            "Regular CBC checks",
                        ],
                    },
                ];
                    ...
                    for (let i = 89; i >= 0; i--) {
                        ...
                        data[dateStr] = {
                            ...
                            wbc:
                                ...
                                (Math.random() - 0.5) * 2,
                            platelets:
                                (overrides.platelets || 200) +
                                (Math.random() - 0.5) * 50,
                            rbc:
                                (overrides.rbc || 4.5) +
                                (Math.random() - 0.5) * 0.5,
                            hemoglobin:
                                (overrides.hemoglobin || 14) +
                                (Math.random() - 0.5) * 1,
                            ldh:
                                (overrides.ldh || 150) +
                                (Math.random() - 0.5) * 40,
                            calcium:
                                (overrides.calcium || 9.5) +
                                (Math.random() - 0.5) * 1,
                            albumin:
                                (overrides.albumin || 4.0) +
                                (Math.random() - 0.5) * 0.5,
                            lymphocytes:
                                (overrides.lymphocytes || 30) +
                                (Math.random() - 0.5) * 5,
                        };
                    }
                    return data;
                ...
                function renderCohortView() {
                    ...
                    patients
                        ...
                        .forEach((patient) => {
                            ...
                            const card = `
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer overflow-hidden" data-id="${
                    patient.id
                }">
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <div class="text-right">
                                <div class="flex items-center space-x-2 mb-1">
                                    ...
                                    <span class="text-xs font-medium text-gray-600">${riskText}</span>
                                </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-3">
                            <div class="grid grid-cols-3 gap-4 text-center mb-3">
                                <div>
                                    <p class="text-xs text-gray-500 mb-1">WBC</p>
                                    <p class="font-semibold text-gray-900">${patient.bloodTest.wbc.toFixed(
                                        1
                                    )}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 mb-1">Hgb</p>
                                    <p class="font-semibold text-gray-900">${patient.bloodTest.hemoglobin.toFixed(
                                        1
                                    )}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 mb-1">Platelets</p>
                                    <p class="font-semibold text-gray-900">${patient.bloodTest.platelets.toFixed(
                                        0
                                    )}</p>
                                </div>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <input type="checkbox" data-id="${
                                    patient.id
                                }" class="compare-checkbox h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            </div>
                        </div>
                    </div>
                </div>`;
                ...
                function updateCompareButtonState() {
                    ...
                    if (selectedPatients.size === 2) {
                        ...
                        (compareButton as HTMLButtonElement).disabled = false;
                    } else {
                        ...
                        (compareButton as HTMLButtonElement).disabled = true;
                    }
                }
          ...
          `
            ...
            `;
                    ...
                    if (aiContentTitle) aiContentTitle.textContent = "";
                    ...
                    document
                        .querySelectorAll(".trends-period-button")
                        .forEach((button) => {
                ...
                function renderFullPatientDetails(patient: Patient) {
                    ...
                    const bloodTestList =
                        document.getElementById("blood-test-list");
                    const boneMarrowList =
                        document.getElementById("bone-marrow-list");
                    const symptomsList =
                        document.getElementById("symptoms-list");

                    if (detailGender)
                        detailGender.textContent = patient.gender || "N/A";

                    if (bloodTestList) {
                        bloodTestList.innerHTML = `
                            <li class="flex justify-between"><span>WBC:</span> <span class="font-semibold">${
                                patient.bloodTest.wbc
                            } K/uL</span></li>
                            <li class="flex justify-between"><span>RBC:</span> <span class="font-semibold">${
                                patient.bloodTest.rbc
                            } M/uL</span></li>
                            <li class="flex justify-between"><span>Hemoglobin:</span> <span class="font-semibold">${
                                patient.bloodTest.hemoglobin
                            } g/dL</span></li>
                            <li class="flex justify-between"><span>Platelets:</span> <span class="font-semibold">${
                                patient.bloodTest.platelets
                            } K/uL</span></li>
                            <li class="flex justify-between"><span>LDH:</span> <span class="font-semibold">${
                                patient.bloodTest.ldh
                            } U/L</span></li>
                            ${
                                patient.bloodTest.calcium
                                    ? `<li class="flex justify-between"><span>Calcium:</span> <span class="font-semibold">${patient.bloodTest.calcium} mg/dL</span></li>`
                                    : ""
                            }
                            ${
                                patient.bloodTest.albumin
                                    ? `<li class="flex justify-between"><span>Albumin:</span> <span class="font-semibold">${patient.bloodTest.albumin} g/dL</span></li>`
                                    : ""
                            }
                            ${
                                patient.bloodTest.b2m
                                    ? `<li class="flex justify-between"><span>B2M:</span> <span class="font-semibold">${patient.bloodTest.b2m} mg/L</span></li>`
                                    : ""
                            }
                            ${
                                patient.bloodTest.mProtein
                                    ? `<li class="flex justify-between"><span>M-Protein:</span> <span class="font-semibold">${patient.bloodTest.mProtein} g/dL</span></li>`
                                    : ""
                            }
                        `;
                    }
                    ...
                    if (boneMarrowList) {
                        boneMarrowList.innerHTML = `
                            ${
                                patient.boneMarrow?.blasts
                                    ? `<li class="flex justify-between"><span>Blasts %:</span> <span class="font-semibold">${patient.boneMarrow.blasts}%</span></li>`
                                    : ""
                            }
                            ${
                                patient.boneMarrow?.cellularity
                                    ? `<li class="flex justify-between"><span>Cellularity:</span> <span class="font-semibold">${patient.boneMarrow.cellularity}%</span></li>`
                                    : ""
                            }
                            ${
                                patient.boneMarrow?.plasmaCells
                                    ? `<li class="flex justify-between"><span>Plasma Cells %:</span> <span class="font-semibold">${patient.boneMarrow.plasmaCells}%</span></li>`
                                    : ""
                            }
                            ${
                                patient.genetics?.mutations
                                    ? `<li class="flex justify-between"><span>Mutations:</span> <span class="font-semibold">${patient.genetics.mutations.join(
                                          ", "
                                      )}</span></li>`
                                    : ""
                            }
                    ...
                    if (symptomsList) {
                        symptomsList.innerHTML = patient.symptoms
                            .map((symptom: string) => `<li>- ${symptom}</li>`)
                            .join("");
                    }
                }
                ...
                function setupChartSelection(patient: Patient) {
                    ...
                    document
                        .querySelectorAll(".chart-select-button")
                        .forEach((button) => {
                            button.addEventListener("click", (e) => {
                                document
                                    .querySelectorAll(".chart-select-button")
                                ...
                                const selectedDaysButton =
                                    document.querySelector(
                                        ".trends-period-button.bg-blue-600"
                                    ) as HTMLElement;
                                const days = selectedDaysButton
                                    ? parseInt(
                                          selectedDaysButton.dataset.days ||
                                              "90",
                                          10
                                      )
                                    : 90;
                                ...
                                if (chartType === "trends")
                                    renderChart(patient.trends, days);
                                else if (chartType === "blood-cell")
                                    renderBloodCellChart(patient.trends, days);
                                else if (chartType === "lab-results")
                                    renderLabResultsChart(patient.trends, days);
                            });
                        });

                    // Set default chart
                    const defaultPeriodButton = document.querySelector(
                        '.trends-period-button[data-days="90"]'
                    ) as HTMLElement;
                    const defaultChartButton = document.querySelector(
                        '.chart-select-button[data-chart="trends"]'
                    ) as HTMLElement;
                    if (defaultPeriodButton) defaultPeriodButton.click();
                ...
                function renderChart(data: Patient['trends'], days = 90) {
                    ...
                    const wbcData = labels.map((key) => data[key].wbc);
                    ...
                    if (!canvas) return;
                    myChart = new (window as any).Chart(
                ...
                function renderBloodCellChart(trendsData: Patient['trends'], days = 90) {
                    ...
                    const trendKeys = Object.keys(trendsData)
                        .reverse()
                        .slice(0, days);
                    const relevantTrends = trendKeys.map(
                        (key) => trendsData[key]
                    );

                    const avgRbc =
                        relevantTrends.reduce((sum, t) => sum + t.rbc, 0) /
                        relevantTrends.length;
                    const avgHemoglobin =
                        relevantTrends.reduce(
                            (sum, t) => sum + t.hemoglobin,
                            0
                        ) / relevantTrends.length;
                    const avgPlatelets =
                        relevantTrends.reduce(
                            (sum, t) => sum + t.platelets,
                            0
                        ) / relevantTrends.length;
                ...
                function renderLabResultsChart(trendsData: Patient['trends'], days = 90) {
                    ...
                    const avgLdh =
                        relevantTrends.reduce((sum, t) => sum + t.ldh, 0) /
                        relevantTrends.length;
                    const avgCalcium =
                        relevantTrends.reduce((sum, t) => sum + t.calcium, 0) /
                        relevantTrends.length;
                    const avgAlbumin =
                        relevantTrends.reduce((sum, t) => sum + t.albumin, 0) /
                        relevantTrends.length;
                    ...
                    if (avgLdh) {
                        data.push(avgLdh);
                        labels.push("Avg LDH (U/L)");
                    }
                    if (avgCalcium) {
                        data.push(avgCalcium);
                        labels.push("Avg Calcium (mg/dL)");
                    }
                    if (avgAlbumin) {
                        data.push(avgAlbumin);
                        labels.push("Avg Albumin (g/dL)");
                    }
                    ...
                    myChart = new (window as any).Chart(ctx, {
                        ...
                        options: {
                            ...
                            plugins: {
                                ...
                                title: {
                                    display: true,
                                    text: `Average Lab Results (${days} Days)`,
                                },
                            },
                        },
                    });
                ...
                let comparisonChart1: any, comparisonChart2: any;
                function renderComparisonView() {
                    if (!comparisonPanels) return;
                    ...
                    [patient1, patient2].forEach((patient, index) => {
                        ...
                        if (vitalsList && latestVitals) {
                            vitalsList.innerHTML = `
                                <li class="flex justify-between items-center bg-gray-50 p-2 rounded-lg text-gray-900"><span>WBC</span><span class="font-semibold">${latestVitals.wbc.toFixed(
                                    1
                                )} K/uL</span></li>
                                <li class="flex justify-between items-center bg-gray-50 p-2 rounded-lg text-gray-900"><span>Hemoglobin</span><span class="font-semibold">${latestVitals.hemoglobin.toFixed(
                                    1
                                )} g/dL</span></li>
                                <li class="flex justify-between items-center bg-gray-50 p-2 rounded-lg text-gray-900"><span>Platelets</span><span class="font-semibold">${latestVitals.platelets.toFixed(
                                    0
                                )} K/uL</span></li>
                            `;
                        }
                ...
                function renderSinglePatientComparison() {
                    ...
                    if (!day1Data || !day2Data) {
                        if (dayComparisonChartContainer)
                            dayComparisonChartContainer.classList.add("hidden");
                        if (dayComparisonTextContainer) {
                            dayComparisonTextContainer.classList.remove(
                                "hidden"
                            );
                    ...
                    const vitals = ["wbc", "platelets", "hemoglobin"];
                    let summaryHtml = "";
                    ...
                    vitals.forEach((metric) => {
                        ...
                        if (diff > 0) {
                            trend = `Increased by ${diffStr}`;
                            icon = "fa-arrow-up text-red-500";
                            color = "text-red-600";
                        } else if (diff < 0) {
                            trend = `Decreased by ${Math.abs(diff).toFixed(2)}`;
                            icon = "fa-arrow-down text-green-500";
                            color = "text-green-600";
                        } else {
                            trend = "No change";
                        }
                        summaryHtml += `<li class="flex items-center justify-between text-sm"><div class="flex items-center"><i class="fas ${icon} w-4 mr-3"></i><span class="font-medium capitalize text-gray-700">${metric.replace(
                            /_/g,
                            " "
                        )}</span></div><div class="font-semibold ${color}">${trend}</div></li>`;
                    });
                    summaryHtml += "</ul>";
                    if (dayComparisonTextContainer) {
                    ...
                    const metrics = ["wbc", "platelets", "hemoglobin"];
                    const labels = metrics.map((m) => m.replace(/_/g, " "));
                    const canvas = document.getElementById(
                        "day-comparison-chart"
                    ) as HTMLCanvasElement;
                    if (!canvas) return;
                    dayComparisonChart = new (window as any).Chart(
                        canvas.getContext("2d"),
                        {
                            type: "bar",
                            data: {
                ...
                if (generatePlanButton)
                    generatePlanButton.addEventListener("click", async () => {
                        ...
                        const vitals = Object.values(currentPatient.trends)
                            ...
                            .map(
                                (v: any) =>
                                    `WBC: ${v.wbc}, Platelets: ${v.platelets}, Hemoglobin: ${v.hemoglobin}`
                            )
                            .join(", ");
                        const prompt = `Act as a healthcare consultant. Based on the patient's data (disease: ${
                            currentPatient.disease
                        }, gender: ${currentPatient.gender}, age: ${
                            currentPatient.age
                        }, risk score: ${(
            ...
            <div className="bg-white overflow-hidden w-full transition-all duration-300">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between">
                            <div className="flex items-center space-x-4 mb-4 md:mb-0">
                                <div className="flex items-center justify-center w-16 h-16 bg-white/20 rounded-2xl backdrop-blur-sm">
                                    <i className="fas fa-chart-line text-2xl md:text-3xl"></i>
                                </div>
                                <div>
                ...
                <main className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
                    <div
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600 text-lg">
                                Monitor and analyze patient risk profiles with
                                AI-powered insights
                            </p>
                        </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                <div className="flex-1">
                                    ...
                                    <p className="text-gray-600 text-sm">
                                        Select up to 2 patients to compare their
                                        risk profiles and treatment outcomes
                                    </p>
                                </div>
                                <button
                                    id="compare-button"
                                    className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 py-3 rounded-lg font-semibold text-sm shadow-md hover:shadow-lg transition-all duration-200 opacity-50 cursor-not-allowed flex items-center space-x-2">
                        ...
                        <div
                            id="patient-list"
                            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"></div>
                    </div>
                    ...
                    <div
                        ...
                        <button
                            id="back-button"
                            className="inline-flex items-center space-x-2 px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors duration-200 mb-6">
                            ...
                            <div className="lg:w-1/3">
                                <div className="bg-gray-50 p-6 rounded-xl shadow-inner">
                                    ...
                                    <div className="bg-white rounded-xl shadow p-4 mt-4">
                                        ...
                                        <ul
                                            id="blood-test-list"
                                            className="text-gray-800 space-y-1 text-sm"></ul>
                                    </div>
                                    <div className="bg-white rounded-xl shadow p-4 mt-4">
                                        <h5 className="font-semibold text-gray-800 mb-2">
                                    ...
                                    <div className="bg-white rounded-xl shadow p-4 mt-4">
                                        ...
                                        <ul
                                            id="symptoms-list"
                                            className="text-gray-800 space-y-1 text-sm list-disc list-inside"></ul>
                                    </div>
                                    <div className="bg-white rounded-xl shadow p-4 mt-4">
                                        <h5 className="font-semibold text-gray-800 mb-2">
                                ...
                                <div className="bg-white p-6 rounded-xl shadow">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between border-b border-gray-200 mb-4">
                                        <div className="flex space-x-2">
                                            <button
                                                data-chart="trends"
                                                className="chart-select-button py-2 px-4 text-sm font-medium text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-t-md transition-colors">
                                                Vitals Trend
                                            </button>
                                            <button
                                                data-chart="blood-cell"
                                                className="chart-select-button py-2 px-4 text-sm font-medium text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-t-md transition-colors">
                                                Blood Counts
                                            </button>
                                            <button
                                                data-chart="lab-results"
                                                className="chart-select-button py-2 px-4 text-sm font-medium text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-t-md transition-colors">
                                                Lab Results
                                            </button>
                                        </div>
                                        <div
                                            id="trends-period-selector"
                                            className="flex space-x-2 mb-2 md:mb-0">
                                            <button
                                                data-days="90"
                                                className="trends-period-button bg-blue-600 text-white px-3 py-1 text-xs font-semibold rounded-md hover:bg-blue-700 transition-colors">
                                                90D
                                            </button>
                                            <button
                                                data-days="60"
                                                className="trends-period-button bg-gray-200 text-gray-800 px-3 py-1 text-xs font-semibold rounded-md hover:bg-gray-300 transition-colors">
                                                60D
                                            </button>
                                            <button
                                                data-days="30"
                    ...
                    <div
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600 text-lg">
                                Compare patient metrics and treatment outcomes
                                side by side
                            </p>
                        </div>
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                            ...
                            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                                <div className="flex-1">
                                    ...
                                    <input
                                        type="date"
                                        id="compare-date1"
                                        className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    />
                                </div>
                                <div className="flex-1">
                                    <label
                        ...
                        <div
                            ...
                            className="grid grid-cols-1 lg:grid-cols-2 gap-6"></div>
                    </div>
                </main>
            </div>
        </div>
